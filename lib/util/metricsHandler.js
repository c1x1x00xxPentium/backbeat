...
const latencyMetric = new promClient.Histogram({
    name: 'replication_stage_latency',
    help: 'Latency of a specific stage in replication',
 ...
 * @property {HistogramObserve} latency - Observes the latency metric
 */
const metricsHandler = {
    ...
    latency: wrapHistogramObserve(latencyMetric),
};
